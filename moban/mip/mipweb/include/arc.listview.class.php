...

{
...

        {
...

            {
...

                {
                    ...
                    $row['typelink'] = "<a target='_blank' href='".$row['typeurl']."'>".$row['typename']."</a>";

                    $row['image'] = "<img src='".$row['picname']."' border='0' width='$imgwidth' height='$imgheight' alt='".preg_replace("/['><]/", "", $row['title'])."'>";

                    $row['imglink'] = "<a target='_blank' href='".$row['filename']."'>".$row['image']."</a>";
                    ...
                    $row['textlink'] = "<a target='_blank' href='".$row['filename']."'>".$row['title']."</a>";
...

    {
	    ...
	    $baseUrl = $GLOBALS['cfg_basehost'].ereg_replace('{cmspath}',$GLOBALS['cfg_cmspath'],$this->Fields['typedir']);
...

        {
            ...
            $prepage.="<a target='_blank' href='".$baseUrl."/".str_replace("{page}",$prepagenum,$tnamerule)."'>往前</a>\r\n";

            $indexpage="<a target='_blank' href='".$baseUrl."/".str_replace("{page}",1,$tnamerule)."'>首页</a>\r\n";
...

        {
            ...
            $nextpage.="<a target='_blank' href='".$baseUrl."/".str_replace("{page}",$nextpagenum,$tnamerule)."'>向后</a>\r\n";

            $endpage="<a target='_blank' href='".$baseUrl."/".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a>\r\n";
...

        {
...

            {
                ...
                $listdd.="<a target='_blank' href='".$baseUrl."/".str_replace("{page}",$j,$tnamerule)."'>".$j."</a>\r\n";
...

    {
...

        {
            ...
            $prepage.="<li><a target='_blank' href='".$purl."PageNo=$prepagenum'>往前</a></li>\r\n";

            $indexpage="<li><a target='_blank' href='".$purl."PageNo=1'>首页</a></li>\r\n";
...

        {
            ...
            $indexpage="<li><a target='_blank'>首页</a></li>\r\n";
...

        {
            ...
            $nextpage.="<li><a target='_blank' href='".$purl."PageNo=$nextpagenum'>向后</a></li>\r\n";

            $endpage="<li><a target='_blank' href='".$purl."PageNo=$totalpage'>末页</a></li>\r\n";
...

        {
            ...
            $endpage="<li><a target='_blank'>末页</a></li>\r\n";
...

        {
...

            {
                ...
                $listdd.= "<li class=\"thisclass\"><a target='_blank'>$j</a></li>\r\n";
...

            {
                ...
                $listdd.="<li><a target='_blank' href='".$purl."PageNo=$j'>".$j."</a></li>\r\n";
